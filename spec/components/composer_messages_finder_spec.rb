...
describe ComposerMessagesFinder do
  ...
  context "delegates work" do
    ...
    subject!(:finder) { ComposerMessagesFinder.new(user, composerAction: 'createTopic') }
  ...
  context '.check_education_message' do
    ...
    context 'creating reply' do
      subject!(:finder) { ComposerMessagesFinder.new(user, composerAction: 'reply') }
  ...
  #   context "reply" do
  #     subject!(:finder) { ComposerMessagesFinder.new(user, composerAction: 'reply', topic_id: topic.id) }
